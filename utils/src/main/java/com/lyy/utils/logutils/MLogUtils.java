package com.lyy.utils.logutils;
...
public class MLogUtils {
    public static final String TAG = MLogUtils.class.getSimpleName();
    /**
     * 控制变量，是否显示log日志
     */
    ...
    public static void init(boolean isShowLog, String defaultMsg) {
        MLogUtils.isShowLog = isShowLog;
        MLogUtils.defaultMsg = defaultMsg;
    }
